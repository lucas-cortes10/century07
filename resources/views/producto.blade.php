...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top"> <!-- Minetras la pantalla tenga un minimo de ancho este se AGRANDA -->
        <div class="container-fluid">
            <a class="navbar-brand me-auto logoa" href="#"><img src="{{ asset('img/5.png')}}" alt="" class="logopag"></a>
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mx-lg-2 active" href="#">Productos</a>
                        </li>
            ...
            <a href="ini.html" class="boton-login">Iniciar Sesion</a>
    ...
    <h3  class="text-center text-white title">Productos Disponibles</h3>

    <div class="container-fluid d-flex align-items-center mb-5">

        <div class="row productos row-cols-auto text-center">

            <div class="col g-col-6 p-2 produ">
            ...
            <div class="col g-col-6 p-2 produ">
                <img src="{{ asset('img/productos/logitech733.png')}}" alt="" class="imgproducto">
                <div class="info">
                <p>Audifonos logitech</p>
                <span>$1.000.000</span>
                </div>
                <a href="compra.html">Agregar al carrito</a>
            </div>
            ...
            <div class="col g-col-6 p-2 produ">
                <img src="{{ asset('img/productos/pc.png')}}" alt="" class="imgproducto">
                <div class="info">
                <p>Computador Cougar</p>
                <span>$4.000.000</span>
                </div>
                <a href="compra.html">Agregar al carrito</a>
            </div>
            ...
            <div class="col g-col-6 p-2 produ">
                <img src="{{ asset('img/productos/ventilador.png')}}" alt="" class="imgproducto">
                <div class="info">
                <p>Ventilador LED</p>
                <span>$45.000</span>
                </div>
